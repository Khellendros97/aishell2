...
export const PATHS = {  folder:
  ...
  /** 标签（lucide hash）：#tag 筛选 chips 前缀 */
  hash: '<line x1="4" x2="20" y1="9" y2="9"/><line x1="4" x2="20" y1="15" y2="15"/><line x1="10" x2="8" y1="3" y2="21"/><line x1="16" x2="14" y1="3" y2="21"/>',
  pause: '<rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/>',
  play: '<polygon points="6 3 20 12 6 21 6 3"/>',
  // 指南针（lucide compass 风格；仪表盘面板入口）
  compass:
    '<circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/>',
  // 仪表盘（lucide layout-dashboard 风格）
  dashboard:
  ...
  // SSH 隧道（两端站点 + 横向线路）
  tunnel:
    '<circle cx="5" cy="19" r="2"/><circle cx="19" cy="5" r="2"/><path d="M5 17V5"/><path d="M19 7v12"/><path d="M9 13h6"/><path d="M2 17h6"/><path d="M16 5h6"/>',
  download:
  ...
  /** 检查元素（lucide mouse-pointer-click）：浏览器面板「检查」按钮 */
  inspect:
    '<path d="M9 9l5 12 1.8-5.2L21 14Z"/><path d="M7.2 2.2 8 5.1"/><path d="m5.1 8-2.9-.8"/><path d="M14 4.1 12 6"/><path d="m6 12-1.9 2"/>',
  message:
  ...
  /** AI 助手窗口分离（lucide square-arrow-out-up-right：方框 + 右上外指箭头） */
  popout:
    '<path d="M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6"/><path d="m21 3-9 9"/><path d="M15 3h6v6"/>',
  /** AI 助手窗口聚合（lucide square-arrow-down-left：方框 + 内指箭头，分离的逆操作） */
  combine:
    '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="m16 8-8 8"/><path d="M16 16H8V8"/>',
} as const;
