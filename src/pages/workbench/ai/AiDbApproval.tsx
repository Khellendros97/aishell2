 ...
 * 对照 legacy/pages/workbench/ai-db-approval.ts 逐行移植（React 迁移）：
 * 本文件为命令式模态（自包含 DOM，不经 React 受控状态），导出签名与 legacy 一致
 * （openAiDbApprovalModal / DbRequestDetail，由 ai-engine.ts 消费）。
